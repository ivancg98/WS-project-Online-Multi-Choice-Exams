...
<body>
	...
	<form autocomplete="off" action="insertExam.jsp" method="post">
		...
		<p>
			Date <br /> <input type="text" name="date" required="required" />
		</p>
		<p>
			Time <br /> <input type="text" name="time" required="required" />
		</p>
		<p>
